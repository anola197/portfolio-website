...
//               I&aposm a passionate full-stack developer with a strong foundation in both frontend and backend technologies. From building intuitive UIs with React and Next.js to architecting scalable backends using .NET, FastAPI, and PostgreSQL, 
